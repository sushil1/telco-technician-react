...
class ServiceBookingPage extends React.Component {
  ...
  submit = data =>
    this.props.bookService(data).then(res =>
      this.setState({
        bookingOrder: res.booking.refrenceId,
  ...
  render() {
    ...
    const messageComponent = (
      <Message success icon floating onDismiss={this.handleDismiss}>
      ...
      <Grid.Row centered>
        {showSucessMessage ? (
          ...
          <Grid.Column mobile={14} tablet={10} computer={8}>
            ...
            <Segment color="teal">
              <span>
                We will confirm your booking right away and start to work on
                solving your problems!
              </span>
              <br />
              <Link to="/signup">Sign up with us to track your bookings.</Link>
            </Segment>
          </Grid.Column>
        )}
      </Grid.Row>
