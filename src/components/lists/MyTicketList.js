            ...
            {tickets.map((ticket, i) => (
              <Card key={ticket._id} color="brown" centered>
                <Card.Content>
                  ...
                  {this.props.isAdmin && (
                    <Label as="a" ribbon color="orange">
                ...
                <Card.Content extra>
                  <div className="ui two buttons">
                    {this.props.isAdmin ? (
                      <Button
                        color="teal"
                        onClick={() => this.showUpdateTicketForm(ticket._id)}
                      >
                        Update
                      </Button>
                    ) : ticket.acceptedBy.indexOf(ticket.assignedStaff._id) !==
                    -1 ? (
                      <Button
                        color="teal"
                        onClick={() => this.showUpdateTicketForm(ticket._id)}
                      ...
                      <div className="ui two buttons">
                        <Popup
                          trigger={
                            <Button basic content="Accept" color="green" />
                          }
                          on="click"
                        >
                        ...
                        <Popup
                          trigger={
                            <Button content="Decline" color="red" basic />
                          }
                          on="click"
                        >
                          <Grid divided columns="equal">
